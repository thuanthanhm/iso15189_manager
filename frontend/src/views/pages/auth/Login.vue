...
import api from '@/service/api'; // Import công cụ giao vận vừa tạo

const router = useRouter();

// Các biến lưu trữ dữ liệu người dùng nhập trên màn hình
const username = ref('');
const password = ref('');
const errorMessage = ref(''); // Biến lưu câu cảnh báo nếu nhập sai

// Hàm xử lý khi bấm nút Đăng nhập
const handleLogin = async () => {
    errorMessage.value = ''; // Xóa lỗi cũ
    try {
        // FastAPI yêu cầu dữ liệu gửi lên phải dạng Form Data
        ...
        // Nếu thành công, cất thẻ Token vào trình duyệt
        localStorage.setItem('access_token', response.data.access_token);
        
        // Tự động chuyển hướng vào trang quản trị (Dashboard)
        router.push('/');
    } catch (error) {
        // Nếu Backend báo lỗi (sai pass, sai tài khoản...)
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                    ...
                    <div>
                        ...
                        <InputText id="email1" type="text" placeholder="Username/ email" class="w-full md:w-[30rem] mb-8" v-model="username" />
